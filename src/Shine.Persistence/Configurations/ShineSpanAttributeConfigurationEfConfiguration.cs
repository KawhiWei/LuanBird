...
public class ShineSpanAttributeConfigurationEfConfiguration : IEntityTypeConfiguration<ShineSpanAttribute>
{
    public void Configure(EntityTypeBuilder<ShineSpanAttribute> builder)
    {
