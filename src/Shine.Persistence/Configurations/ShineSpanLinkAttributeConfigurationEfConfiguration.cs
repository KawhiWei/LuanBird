...
public class ShineSpanLinkAttributeConfigurationEfConfiguration : IEntityTypeConfiguration<ShineSpanLinkAttribute>
{
    public void Configure(EntityTypeBuilder<ShineSpanLinkAttribute> builder)
    {
